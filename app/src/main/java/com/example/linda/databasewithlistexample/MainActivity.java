...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button addButton = (Button) this.findViewById(R.id.btnAdd);
        Button delButton = (Button) this.findViewById(R.id.btnDelete);

        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, AddNewCountry.class));
            }
        });
